...
def parse_server(pcmd):
    ...
    try:
        ...
        error_module('parse_server_010','ParseException from dbhack_parser.parse_server','Your command can not be parsed')
        return_list=['Error']
        return return_list
    ...
    if '-' in server_list :
        ...
        if int(server_list[6])  >=  int(server_list[8]):
            error_module('parse_server_030','IP range condition check at dbhack_parser.parse_server','IP Range is not correct')
            return_list=['Error']
            return return_list
        ...
        if int(server_list[6]) > 255 or int(server_list[8]) > 255 or int(server_list[0]) > 255 or int(server_list[2]) > 255 or int(server_list[4]) > 255:
            error_module('parse_server','IP range condition check at dbhack_parser.parse_server','IPs greater than 255')
            return_list=['Error']
            return return_list 
...
def parse_server_port(pcmd):
    ...
    try:
        ...
        error_module('parse_server_port_010','ParseException from dbhack_parser.parse_ping','Your command can not be parsed')
        return_list=['Error']
        return return_list
    ...
    if '-' in server_list :
        ...
        if int(server_list[6])  >=  int(server_list[8]):
            error_module('parse_server_030','IP range condition check at dbhack_parser.parse_server_port','IP Range is not correct')
            return_list=['Error']
            return return_list
        ...
        if int(server_list[6]) > 255 or int(server_list[8]) > 255 or int(server_list[0]) > 255 or int(server_list[2]) > 255 or int(server_list[4]) > 255:
            error_module('parse_server_port_040','IP range condition check at dbhack_parser.parse_server_port_ping','IPs greater than 255')
            return_list=['Error']
            return return_list 
    ...
    # if there is port range , produce port range list
        ...
        if int(port_list[0])  >=  int(port_list[2]):
            error_module('parse_server_port_020','Port range condition check at dbhack_parser.parse_server_port','Port Range is not correct')
            return_list=['Error']
            return return_list
        
        if int(port_list[0])  > 65535 or   int(port_list[2]) > 65535 :
            error_module('parse_server_port_050','Port range condition check at dbhack_parser.parse_server_port','Port is greater than 65535')
            return_list=['Error']
            return return_list
        ...
        return_list.append(portrange_list)
          ...
          if len([ x for x in port_list if int(x) > 65535]):
            error_module('parse_server_port_060','Port range condition check at dbhack_parser.parse_server_port','Port numbers can not be greater than 65535')
            return_list=['Error']
            return return_list
